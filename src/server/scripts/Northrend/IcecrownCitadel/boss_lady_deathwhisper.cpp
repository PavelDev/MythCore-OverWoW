...
enum Spells
{
    ...
    SPELL_SHADOW_BOLT_10_N = 71254,
    SPELL_SHADOW_BOLT_25_N = 72008,
    SPELL_SHADOW_BOLT_10_H = 72503,
    SPELL_SHADOW_BOLT_25_H = 72504,
    SPELL_DEATH_AND_DECAY_10_N = 71001,
    SPELL_DEATH_AND_DECAY_25_N = 72108,
    SPELL_DEATH_AND_DECAY_10_H = 72109,
    SPELL_DEATH_AND_DECAY_25_H = 72110,
    SPELL_DOMINATE_MIND_H = 71289,
    SPELL_FROSTBOLT_10_N = 71420,
    SPELL_FROSTBOLT_25_N = 72007,
    SPELL_FROSTBOLT_10_H = 72501,
    SPELL_FROSTBOLT_25_H = 72502,
    SPELL_FROSTBOLT_VOLLEY_10_N = 72905,
    SPELL_FROSTBOLT_VOLLEY_25_N = 72906,
    SPELL_FROSTBOLT_VOLLEY_10_H = 72907,
    SPELL_FROSTBOLT_VOLLEY_25_H = 72908,
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_DEATH_AND_DECAY:
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM))
                                DoCast(target, RAID_MODE(SPELL_DEATH_AND_DECAY_10_N, SPELL_DEATH_AND_DECAY_25_N, SPELL_DEATH_AND_DECAY_10_H, SPELL_DEATH_AND_DECAY_25_H));
                        ...
                        case EVENT_P1_SHADOW_BOLT:
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM))
                                DoCast(target, RAID_MODE(SPELL_SHADOW_BOLT_10_N, SPELL_SHADOW_BOLT_25_N, SPELL_SHADOW_BOLT_10_H, SPELL_SHADOW_BOLT_25_H));
                        ...
                        case EVENT_P2_FROSTBOLT_VOLLEY:
                            DoCastAOE(RAID_MODE(SPELL_FROSTBOLT_VOLLEY_10_N, SPELL_FROSTBOLT_VOLLEY_25_N, SPELL_FROSTBOLT_VOLLEY_10_H, SPELL_FROSTBOLT_VOLLEY_25_H));
