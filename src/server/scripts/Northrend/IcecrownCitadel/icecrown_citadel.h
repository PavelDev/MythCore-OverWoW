...
enum DataTypes
{
    ...
    DATA_BEEN_WAITING_ACHIEVEMENT = 30,
    DATA_SPIRIT_ALARM1 = 31,
    DATA_SPIRIT_ALARM2 = 32,
    DATA_SPIRIT_ALARM3 = 33,
    DATA_SPIRIT_ALARM4 = 34,

    DATA_DEATHBOUND_WARD1 = 35,
    DATA_DEATHBOUND_WARD2 = 36,
    DATA_DEATHBOUND_WARD3 = 37,
    DATA_DEATHBOUND_WARD4 = 38,

    DATA_INCONSPICUOUS_LEVER = 39,
    ...
    DATA_VALITHRIA_ALTERNATIVE = 49,
    DATA_VALITHRIA_COMBAT_TRIGGER = 50,
    DATA_TIRION = 51,
    DATA_TERENAS_FIGHTER = 52,
    DATA_SPIRIT_WARDEN = 53,
    DATA_PORTAL_JOCKEY_ACHIEVEMENT = 55,
    DATA_NECK_DEEP_ACHIEVEMENT = 56,
};
